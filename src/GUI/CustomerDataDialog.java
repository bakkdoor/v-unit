...
public class CustomerDataDialog
{
	...
	public CustomerDataDialog(Frame owner)
	{
		...
		this(owner, null, "", "", "", new Date(1, 1, 2000), "", "",
				new Integer(0), "");
	}

	public CustomerDataDialog(Frame owner, Integer CID, String title,
			String firstName, String Lastname, Date birthDate, String street,
			String housNr, Integer zipCode, String city)
	{
	...
	private void fillDataDialog()
	{
		...
		JComboBox comboBoxBirthMonth = new JComboBox(this
		...
		buttonAdd.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				int yearOfBirth = Integer
						.parseInt(textFieldBirthYear.getText());
				int monthOfBirth = comboBoxBirthMonth.getSelectedIndex() + 1;
				int dayOfBirth = comboBoxBirthDay.getSelectedIndex() + 1;
				...
				String identificationNr = textFielID.getText();
		...
		Layout.addComponent(contentPane, textFieldFirstName, 1, 2, 3, 1, 0.7,
				0.0);

		Layout.addComponent(contentPane, labelLastName, 0, 3, 1, 1, 0.3, 0.0);
		Layout.addComponent(contentPane, textFieldLastName, 1, 3, 3, 1, 0.7,
				0.0);

		Layout.addComponent(contentPane, labelBirthDay, 0, 4, 1, 1, 0.3, 0.0);
		Layout.addComponent(contentPane, comboBoxBirthDay, 1, 4, 1, 1, 0.23,
				0.0);
		Layout.addComponent(contentPane, comboBoxBirthMonth, 2, 4, 1, 1, 0.23,
				0.0);
		Layout.addComponent(contentPane, textFieldBirthYear, 3, 4, 1, 1, 0.23,
				0.0);

		Layout.addComponent(contentPane, labelAddress, 0, 5, 1, 1, 0.3, 0.0);
		Layout
				.addComponent(contentPane, textFieldStreet, 1, 5, 2, 1, 0.46,
						0.0);
		Layout.addComponent(contentPane, textFieldHouseNr, 3, 5, 1, 1, 0.23,
				0.0);
		Layout.addComponent(contentPane, textFieldZipCode, 1, 6, 1, 1, 0.23,
				0.0);
